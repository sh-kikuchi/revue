      ...
      <div class="d-sm-none d-md-flex">
        ...
        <div class="sidebar" style="width: 300px">
          <iframe
            ...
            scrolling="no"
            frameborder="0"
            src="https://rcm-fe.amazon-adsystem.com/e/cm?ref=tf_til&t=revue0f-22&m=amazon&o=9&p=8&l=as1&IS2=1&detail=1&asins=B09372PSG7&linkId=1f4566262059ff8eea5bd2a1e6b13398&bc1=000000&amp;lt1=_top&fc1=333333&lc1=0066c0&bg1=ffffff&f=ifr"
          >
          </iframe>
        </div>
      </div>
...
export default {
  ...
  async asyncData({ store, $content, params }) {
    const contents = await $content("blog/php")
